 ...
 */
class MenuNodeBase extends \Symfony\Cmf\Bundle\MenuBundle\Doctrine\Phpcr\MenuNodeBase implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'parent', 'name', 'children', 'label', 'uri', 'route', 'attributes', 'childrenAttributes', 'linkAttributes', 'labelAttributes', 'extras', 'routeParameters', 'display', 'displayChildren', 'routeAbsolute');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MenuNodeBase $proxy) {
