 ...
 */
class AuthCode extends \Mango\API\DomainBundle\Entity\AuthCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'client', 'user', 'redirectUri', 'token', 'expiresAt', 'scope');
        }
