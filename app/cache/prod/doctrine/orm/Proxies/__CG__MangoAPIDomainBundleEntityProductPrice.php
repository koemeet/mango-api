 ...
 */
class ProductPrice extends \Mango\API\DomainBundle\Entity\ProductPrice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'price', 'currency', 'product');
        }
     ...
     * {@inheritDoc}
     */
    public function setProduct(\Mango\API\DomainBundle\Entity\Product $product = NULL)
    {
