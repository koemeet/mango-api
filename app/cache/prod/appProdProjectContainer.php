...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'postGenerateSchema'), 'doctrine_phpcr.jackalope_doctrine_dbal.schema_listener');
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'defineweb_db', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string', 'char' => 'string'));
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_7f2f5a5fe1903d9fd7b93664687e8efc9581832861bd8a223d1acbe4021066f9');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_7f2f5a5fe1903d9fd7b93664687e8efc9581832861bd8a223d1acbe4021066f9');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_7f2f5a5fe1903d9fd7b93664687e8efc9581832861bd8a223d1acbe4021066f9');
        ...
        $f->setProxyDir('/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getDoctrinePhpcr_Odm_DefaultDocumentManagerService()
    {
        ...
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2phpcr_default_7f2f5a5fe1903d9fd7b93664687e8efc9581832861bd8a223d1acbe4021066f9');
        ...
        $k->setProxyDir('/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/doctrine/PHPCRProxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/../web', false);
    }
    ...
    protected function getHateoas_Configuration_RelationsRepositoryService()
    {
        ...
        $g = new \Metadata\Cache\FileCache('/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/hateoas');
    ...
    protected function getJmsSerializer_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/jms_serializer'));
        return $instance;
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod',
            ...
            'session.save_path' => '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/sessions',
            ...
            'router.resource' => '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/doctrine/orm/Proxies',
            ...
            'fos_rest.cache_dir' => '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/fos_rest',
            ...
            'doctrine_phpcr.odm.proxy_dir' => '/Users/Steffen/Development/projects/mango/api.erp.mangowebdesign.nl/app/cache/prod/doctrine/PHPCRProxies',
