 ...
 */
class StaticContentBase extends \Symfony\Cmf\Bundle\ContentBundle\Doctrine\Phpcr\StaticContentBase implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'parent', 'name', 'node', 'id', 'title', 'body');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StaticContentBase $proxy) {
